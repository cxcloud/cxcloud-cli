...
const buildDeploymentManifests = (config, envList = []) => {
  ...
  const image = data.image.repository
    ? `${data.image.repository}:${data.image.name}-${data.image.version}`
    : `${data.image.name}:${data.image.version}`;
  ...
  return [
    {
      ...
      metadata: {
        ...
        name: data.name,
        annotations:
          typeof data.deploymentAnnotations === 'object'
            ? data.deploymentAnnotations
            : {},
        namespace
      },
      spec: {
    ...
    },
    {
      ...
      metadata: {
        ...
        name: data.name,
        annotations:
          typeof data.serviceAnnotations === 'object'
